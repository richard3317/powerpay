...
<html>
	<head>
		<@head label="代付路由信息" base="routDaifu" addSuccMsg="批量新增完成">
	...
	<body>
		<@addDiv label="路由信息" addUrl="/routDaifu/batchAddSubmit.do">
				...
				<tr>
					...
					<td class="content">
						<select id="intTransCdSel" name="intTransCd" data-options="editable:false">
							<@enumOpts enumNm="ProfitEnums.ProfitTxnDaifuTp" showEmptyOpt="true" showCode="true" />
						</select>
					</td>
				</tr>
				<tr>
