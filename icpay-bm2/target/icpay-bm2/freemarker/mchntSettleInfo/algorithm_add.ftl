...
<html>
	...
	<body style="padding: 5px;">
		<div id="addDiv" class="easyui-panel" title="商户清算信息-计费方式新增-${mchntCd}" style="padding: 10px;">
			<form id="addForm" method="post" action="${ctx}/mchntSettleInfo/algorithm/add/submit.do">
