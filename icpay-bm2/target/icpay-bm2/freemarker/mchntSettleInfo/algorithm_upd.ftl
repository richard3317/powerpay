...
<html>
	...
	<body style="padding: 5px;">
		<div id="updDiv" class="easyui-panel" title="商户清算信息-计费方式修改-${algorithm.mchntCd}" style="padding: 10px;">
			<form id="updForm" method="post" action="${ctx}/mchntSettleInfo/algorithm/upd/submit.do">
				...
				<table class="edit_tbl" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="content">
							...
							(<@enumVal enumNm="CurrencyEnums.CurrType" code="${algorithm.currCd}" />)
			...
			<tr>
				...
				<#--  因暂未使用先关闭
				<tr>
					<td class="label">前台通知地址：</td>
					<td class="content">
						<input class="easyui-validatebox" type="text" maxlength="254"
							id="" name="pageReturnUrl" value="${algorithm.pageReturnUrl!}" />
					</td>
				</tr>
				<tr>
					<td class="label">后台通知地址：</td>
					<td class="content">
						<input class="easyui-validatebox" type="text" maxlength="254"
							id="" name="notifyUrl" value="${algorithm.notifyUrl!}"/>
					</td>
				</tr>
				<tr>
					<td class="label">IP白名单：</td>
					<td class="content">
						<input class="easyui-validatebox" type="text" maxlength="254"
							id="" name="whiteIp" value="${algorithm.whiteIp!}"/>
							<span class="inputDesc">如：0.0.0.1|0.0.0.2</span>
					</td>
				</tr>
				<tr>
					<td class="label">IP白名单是否开启：</td>
					<td class="content">
						<input type="hidden" id="whiteIpStateHid" name="" value="${algorithm.whiteIpState!}" />
						<select class="easyui-validatebox" id="transTypeGroupIdSel" name="whiteIpState" style="width: 300px;" required="true">
