...
<html>
	...
	<body style="padding: 5px;">
		<div id="addDiv" class="easyui-panel" title="渠道虚拟终端信息-交易参数新增-${chnlId}-${chnlMchntCd}" style="padding: 10px;">
			<form id="addForm" method="post" action="${ctx}/virtualTerm/transParam/add/submit.do">
					...
					<td class="content">
						<table class="edit_tbl" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td class="content">
									<input class="easyui-validatebox" type="text" maxlength="7"
										id="maxFeeInpt" name="maxFee" /><span class="inputDesc">请输入金额，如：1.00元</span>
								</td>
							</tr>
						</table>
					</td>
