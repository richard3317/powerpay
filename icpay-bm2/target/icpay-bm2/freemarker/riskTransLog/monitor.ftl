<html>
			...
			$(function() {
				...
				$("#detailBtn").click(function() {
					...
					if (sel == null) {
						...
						crtViewDialog("detailDiv", "风险交易信息详情", url, 800, 600);
					}
				});
	...
	<body style="padding: 5px;">
		<div id="qryDiv">
			<form id="qryForm" method="post" action="${ctx}/riskTransLog/monitor/qry.do">
				<table class="qry_tbl" id="monitorQryTbl">
					<tr>
						...
						<td>查询时间范围(分钟)</td>
						<td>
							<input class="easyui-validatebox" type="text" name="_QRY_monitorTm" value="30"
								style="width: 80px; padding-left: 5px;"
								data-options="required:true,validType:['integer','minInteger[1]','maxInteger[300]']"">
						</td>
						<td>显示记录条数</td>
						<td>
							<input class="easyui-validatebox" type="text" name="monitorNum" value="20" 
								style="width: 80px; padding-left: 5px;"
			...
			<div style="margin: 10px 0;">
				<@authCheck funcCode="7000050001">
					<a id="monitorBtn" href="javascript:void(0)" class="easyui-linkbutton">开始监控</a>
