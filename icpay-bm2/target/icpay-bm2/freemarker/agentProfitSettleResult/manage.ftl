...
<html>
	<head>
		<@head label="代理商分潤结果" base="agentProfitSettleResult" qryFuncCode="3000110001"
			detailFlg=true detailDivWidth=800 detailDivHeight=550 detailFuncCode="3000110002"
			detailUrl='"detail.do?agentCd="+sel.agentCd +"&settleDate="+sel.settleDate +"&intTransCd="+sel.intTransCd +"&mchntCd="+sel.mchntCd +"&chnlId="+sel.chnlId +"&chnlMchntCd="+sel.chnlMchntCd' 
			>
			<#--  
			...
			$("#exportBtn").click(function(){
				...
				var url =_ctx + "/agentProfitSettleResult/export.do?"+qryStr;
				console.log(url);
				$.jumpTo(url);
			});
			</@authCheck>
	...
	<body style="padding: 5px;">
		<div id="mngDiv" class="easyui-panel" title="代理商分潤结果" style="padding: 10px;">
			<@qryDiv qryUrl="/agentProfitSettleResult/qry.do" qryFuncCode="3000110001">
				<table class="qry_tbl">
					<tr>
						<td>分润日期：</td>
						<td>
			...
			<@qryResultDiv  
				detailFlg=true detailFuncCode="3000110002"
				>
				<#--  
