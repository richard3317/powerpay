...
<html>
	<head>
		<@head label="${label}" base="riskListMassItem">
		    <#--  
			$("#groupIdInpt").validatebox({
				required: true,
				novalidate: true,
				validType: 'number'
			});
	...
	<body>
		<@addDiv label="${label}" addUrl="/riskListMassItem/add/submit.do">
			<input type="hidden" name="chnlId" value="00"/>
			<input type="hidden" name="mchntCd" value="0000"/>
			<table class="edit_tbl" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="content">
						<input class="easyui-validatebox" type="text" readonly="readonly"
							id="mchntCdInpt" name="mchntCd" value="0000">
					</td>
				</tr>
				-->				
				<tr>
