...
<html>
	<head>
		<@head label="支付路由信息" base="rout" addSuccMsg="批量新增完成">
	...
	<body>
		<@addDiv label="路由信息" addUrl="/rout/batchAddSubmit.do">
			...
			<table class="edit_tbl" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="content">
						<select class="easyui-validatebox" style="width: 400px; height: 27px;"
				...
				<tr>
					...
					<td class="content">
						<select id="intTransCdSel" name="intTransCd" data-options="editable:false">
							<@enumOpts enumNm="ProfitEnums.ProfitTxnTp" exceptValues="5210,5220" showEmptyOpt="true" showCode="true" />
							<#-- <@enumOpts enumNm="BmEnums.TxnPayTypesForSel" selected="01" exceptValues="52,01,012,013,014,--,---" showEmptyOpt="false" showCode="true" /> -->
						</select>
					</td>
				</tr>
				<tr>
