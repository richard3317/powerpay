...
<html>
	...
	<body>
		<@editDiv label="${label}" editUrl="/offpay/offpayAppr/submit.do">
			...
			<table class="edit_tbl" cellpadding="0" cellspacing="0">
				...
				<@authCheck funcCode='6001010006'>
					<tr>
						<td class="label">电汇自充审核：</td>
						<td class="content">
					...
					<tr>
						<td class="label">汇款凭证：</td>
						<td class="content">
							<#if imageUrl == "">
								${proofTitle}
							<#else>	
								<div style="width:800px;height:550px;">
									<img src="${imageUrl}" style='height: 100%; width: 100%; object-fit: contain' align="left">
								</div>
							</#if>
						</td>
					</tr>
