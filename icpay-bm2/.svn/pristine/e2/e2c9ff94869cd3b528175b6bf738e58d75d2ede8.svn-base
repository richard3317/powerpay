...
<html>
			...
			$(function() {
				...
				$("#acctAdjustForm").form({
					...
					success: function(data) {
						...
						$.jumpTo(_ctx + "/chnlAccount/accountAdjust.do?mchntCd=" + $("#mchntCdHid").val()+"&chnlId="+$("#chnlIdHid").val()+ "&currCd=" + $("#currCdHid").val() );
	...
	<body style="padding: 5px;">
		<form id="acctAdjustForm" method="post" action="${ctx}/chnlAccount/accountAdjustSubmit.do">
