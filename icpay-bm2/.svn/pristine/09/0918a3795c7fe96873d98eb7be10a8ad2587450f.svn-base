...
<html>
	...
	<body>
		<@addDiv label="${label}" addUrl="/riskListGroup/add/submit.do">
				...
				<tr>
					...
					<td class="content">
						<select id="groupTpSel" name="groupTp" data-options="editable:false">
							<@enumOpts enumNm='RiskEnums.GroupTp' showCode='true' showEmptyOpt='false' />
						</select>
					</td>
				</tr>
				<tr>
					...
					<td class="content">
						<select id="listTpSel" name="listTp" data-options="editable:false">
							<@enumOpts enumNm='RiskEnums.ListTp' showCode='true' showEmptyOpt='false' />
						</select>
					</td>
				</tr>
				<tr>
