...
<html>
	...
	<body style="padding: 5px;">
		<div id="addDiv" class="easyui-panel" title="渠道虚拟终端信息-清算信息新增-${chnlId}-${chnlMchntCd}" style="padding: 10px;">
			<form id="addForm" method="post" action="${ctx}/virtualTerm/settlePolicy/add/submit.do">
			...
			<table class="edit_tbl" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="content">
						<select id="settlePeriodSel" name="settlePeriod" data-options="editable:false">
				...
				<tr id="transferModeTr">
					...
					<td class="content">
						<select class="easyui-validatebox" id="transferModeSel" name="transferMode" style="width: 300px;">
							<option value="0">默认模式</option>
							<option value="1">A/B商户</option>
						</select>
					</td>
				</tr>
			</table>
