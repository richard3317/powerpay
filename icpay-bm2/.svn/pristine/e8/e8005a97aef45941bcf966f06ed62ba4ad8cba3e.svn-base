...
@Controller
@RequestMapping("/transLogQuxian")
public class TransLogQuxianController extends TransLogBaseController {

	private static final String RESULT_BASE_URI = "transLogQuxian";
	...
	public @ResponseBody AjaxResult qry(Model model, int pageNum, int pageSize, String mon) {
		...
		return this.query(model, BMConstants.PAGE_TBLWITH_DRAW_LOG, qryParamMap, pageNum, pageSize, mon);
	}
