...
<html>
	<head>
		<@head label="${label}" base="transLogQuxian" >
	...
	<body>
		<@editDiv label="${label}" editUrl="/transLogQuxian/transSateModify/submit.do">
			...
			<table class="edit_tbl" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td class="label">代付订单号：</td>
					<td class="content" >
						<input class="easyui-validatebox" type="text" maxlength="40" readonly="readonly"
								id="orderSeqIdInpt" name="orderSeqId" value="${entity.orderSeqId}" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="content">
						<select id="orderStateSel" name="orderState" data-options="editable:false">
