...
@Controller
@RequestMapping("/rout")
public class RouteController extends RouteBaseController {
	...
	@RequestMapping(value = "/exportRoutLog.do", method = RequestMethod.GET)
	public @ResponseBody void exportRoutLog(Model model, HttpServletResponse response) {
		String filename = BMConfigCache.getConfig(BMConstants.CONFIG_KEY_ROUT_EXPORT_FILENM);
