...
<html>
	<head>
		<@head label="${label}" base="virtualTransLog" >
	...
	<body>
		<@editDiv label="${label}" editUrl="/virtualTransLog/transSateModify/submit.do">
				...
				<tr>
					...
					<td class="content">
						<select id="txnStateSel" name="opType" data-options="editable:false" style="width: 300px;" >
							<@enumOpts enumNm='TxnEnums.TransLogIncomeAdjustOp' showCode='true' exceptValues="13,74,75,76"
								showEmptyOpt="false" selected="11" />
						</select>
					</td>
				</tr>				
				<tr>
