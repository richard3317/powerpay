...
<html>
		...
		<script type="text/javascript">
			$(function() {
				$("#backBtn").click(function() {
					$.jumpTo(_ctx + "/chnlAccount/accountFlow.do?mchntCd=" + $("#mchntCdHid").val() + "&chnlId=" + $("#chnlIdHid").val());
				});
	...
	<body style="padding: 5px;">
		<form id="flowNoteEditForm" method="post" action="${ctx}/chnlAccount/flowNoteEdit.do">
