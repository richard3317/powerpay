...
<#macro formRadioButtons path options separator attributes="">
    ...
    <input type="radio" id="com.ppay:icpay-mer2:war:2.0.1-SNAPSHOT" name="${status.expression}" value="${value?html}"<#if stringStatusValue == value> checked="checked"</#if> ${attributes}<@closeTag/>
    <label for="com.ppay:icpay-mer2:war:2.0.1-SNAPSHOT">${options[value]?html}</label>${separator}
    </#list>
</#macro>
...
<#macro formCheckboxes path options separator attributes="">
    ...
    <#assign id="${status.expression?replace('[','')?replace(']','')}${value_index}">
    <#assign isSelected = contains(status.actualValue?default([""]), value)>
    <input type="checkbox" id="com.ppay:icpay-mer2:war:2.0.1-SNAPSHOT" name="${status.expression}" value="${value?html}"<#if isSelected> checked="checked"</#if> ${attributes}<@closeTag/>
    <label for="com.ppay:icpay-mer2:war:2.0.1-SNAPSHOT">${options[value]?html}</label>${separator}
    </#list>
...
<#macro formCheckbox path attributes="">
	...
	<input type="hidden" name="_${status.expression}" value="on"/>
	<input type="checkbox" id="com.ppay:icpay-mer2:war:2.0.1-SNAPSHOT" name="${status.expression}"<#if isSelected> checked="checked"</#if> ${attributes}/>
</#macro>
