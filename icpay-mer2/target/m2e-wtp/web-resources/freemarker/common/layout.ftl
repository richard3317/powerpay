	...
	<body>
		<div id="top-tool">
			<div class="center_wrapper">
				<div id="top-tool-msg"><@msg code='layout.欢迎使用' default='欢迎使用'/>威力付<@msg code='layout.商户服务网站' default='商户服务网站'/>.</div>
				<div id="top-tool-nav">
		...
		<div id="footer1" >
            <div class="center_wrapper">
                <div class="navbar-left"><a class="pic" target="_blank" href="#" ><img src="https://static.anquan.org/static/outer/image/aqkx_124x47.png"></img></a><p class="con"></p></div>
            </div>
	    </div>
