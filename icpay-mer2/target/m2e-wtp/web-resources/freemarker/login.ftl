...
<html>
	<head>
		<title>威力付><@msg code='login.商户服务网站' default='商户服务网站'/></title>
		...
		<script type="text/javascript">
		 ...
		 function initLan(){
			...
			console.log("defaultLan的内容："+ "zh_CN");
	...
	<body>
		<div id="header">
			...
			<div class="center_wrapper">
    			...
    			<div id="navbar-right" class="navbar-right" >
    				<a href="${ctx}/" style=""><@msg code='login.首页' default='首页'/></a>
    				<a href="" style=""><@msg code='login.官网' default='官网'/></a>
		            <a href="#" style=""><@msg code='login.个人服务' default='个人服务'/></a>
        		</div>
...
<div id="content" >
			            ...
			            <div class="hpanel">
			                <div class="panel-body">
			                        <form action="${ctx}/login" id="loginFrm" name="loginFrm">
			                            ...
			                            <a id="loginBtn" class="btn btn-success btn-block" href="#" style="font-size: 16px; font-weight: 800;"  data-toggle="modal" data-target="#operation480" ><@msg code='login.登录' default='登录'/></a>
			                       </form>
			                </div>
			            </div>
			        </div>
		...
		<div id="business" class="center_wrapper" style="display: none;">
			<div class="col-sm-4 col-md-3">
				<div class="thumbnail">
					<img src="${ctx}/resources/images/gjk_338_454.png" width="169" />
				</div>
				<div class="caption" style="text-align: center;font-weight: bold;font-size: 20px;">金融</div>
			</div>
			<div class="col-sm-4 col-md-3">
				<div class="thumbnail">
					<img src="${ctx}/resources/images/sdm_338_454.png"  width="169" />
				</div>
				<div class="caption" style="text-align: center;font-weight: bold;font-size: 20px;">安全</div>
			</div>
			<div class="col-sm-4 col-md-3">
				<div class="thumbnail">
					<img src="${ctx}/resources/images/zsyk_338_454.png" width="169" />
				</div>
				<div class="caption" style="text-align: center;font-weight: bold;font-size: 20px;">快速</div>
			</div>
			<div class="col-sm-4 col-md-3">
				<div class="thumbnail">
					<img src="${ctx}/resources/images/etc_338_454.png"  width="169" />
				</div>
				<div class="caption" style="text-align: center;font-weight: bold;font-size: 20px;">高效</div>
			</div>
	    </div>
	     
		<div id="footer">
		<div class="div1"><a class="pic" target="_blank" href="#" ><img src="https://static.anquan.org/static/outer/image/aqkx_124x47.png"></img></a><p class="con"></p></div>
	    </div>
