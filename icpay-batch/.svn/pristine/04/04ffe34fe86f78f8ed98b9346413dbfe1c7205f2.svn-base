...
@Component("T1BalanceTransferJob")
public class T1BalanceTransferJob extends BaseQuartzJob {
	
	@Override
	public void doProcess() {
		String batchDt = DateUtil.fuzzyBatchDayT1(getFuzzyDayCutTimeT1());
		IBatchTask bo = ApplicationContextUtil.getBean("T1BalanceTransferTask");
