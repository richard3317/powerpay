 ...
 * @mbg.generated
 */
public class OrganMchntInfo extends OrganMchntInfoKey implements Serializable {
    /**
     * 状态(1=有效)
     ...
     * @mbg.generated
     */
    public OrganMchntInfo(String organId, String mchntCd, String state, String comment, String lastOperId, Date recCrtTs, Date recUpdTs) {
    ...
    public boolean equals(Object that) {
        ...
        OrganMchntInfo other = (OrganMchntInfo) that;
     ...
     * @mbg.generated
     */
    public void cloneFrom(OrganMchntInfo source) {
