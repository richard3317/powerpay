 ...
 * @mbg.generated
 */
public class RoutInfo extends RoutInfoKey implements Serializable {
    /**
     * Database column : tbl_rout_info.chnl_ids
     *
     * @mbg.generated
     */
    ...
    /**
     * Database column : tbl_rout_info.last_oper_id
     *
     * @mbg.generated
     */
    ...
    /**
     * Database column : tbl_rout_info.rec_crt_ts
     *
     * @mbg.generated
     */
    ...
    /**
     * Database column : tbl_rout_info.rec_upd_ts
     *
     * @mbg.generated
     */
     ...
     * @mbg.generated
     */
    public RoutInfo(String mchntCd, String intTransCd, String payType, String termSnRegex, String chnlIds, String lastOperId, Date recCrtTs, Date recUpdTs) {
        super(mchntCd, intTransCd, payType, termSnRegex);
     ...
     * @mbg.generated
     */
    public void setChnlIds(String chnlIds) {
        this.chnlIds = chnlIds;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getMchntCd() == null ? other.getMchntCd() == null : this.getMchntCd().equals(other.getMchntCd()))
            ...
            && (this.getChnlIds() == null ? other.getChnlIds() == null : this.getChnlIds().equals(other.getChnlIds()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getChnlIds() == null) ? 0 : getChnlIds().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", chnlIds=").append(chnlIds);
     ...
     * @mbg.generated
     */
    public void cloneFrom(RoutInfo source) {
        super.cloneFrom(source);
        this.chnlIds=source.chnlIds;
